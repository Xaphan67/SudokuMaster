        ...
        <div id="classements">
            <section>
                <div class="onglets onglets_classements">
                    <p class="onglet_actif"><img src="view/assets/svg/Solo.svg" alt =""></p>
                    <p><img src="view/assets/svg/Cooperatif.svg" alt =""></p>
                    <p><img src="view/assets/svg/Competitif.svg" alt =""></p>
                </div>
                <?php
                    for ($mode = 1; $mode <= 3; $mode++) {
                    ?>
                        <div id="classements_<?php echo ($mode == 1 ? 'solo' : ($mode == 2 ? 'cooperatif' : 'competitif')) ?>">
                            <div class="top_3">
                                <?php
