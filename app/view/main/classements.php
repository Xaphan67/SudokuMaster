                ...
                ?>
                    <div>
                        <div>
                            ...
                            <img src="app/view/assets/svg/<?php echo ($mode == 1 ? 'Solo' : ($mode == 2 ? 'Cooperatif' : 'Competitif')) ?>.svg" alt="">
                        </div>
                        <div class="top_3">
                            <?php
                                    ...
                                    ?>
                                        <div>
                                            <div class="info_joueur">
                                                ...
                                                <img src="app/view/assets/svg/Fleche.svg" alt="">
                                            </div>
                                            <img src="app/view/assets/img/Trophee<?php echo ($place == 0 ? 'Or' : ($place == 1 ? 'Argent' : 'Bronze')) ?>.webp" alt="">
