    ...
    <div id="conteneur_principal" class="vertical">
        ...
        <section id="regles" class="vertical">
            <div class="onglets onglets_regles">
                ...
                <p>Processus d'élimination</p>
            </div>
            <div id="regles_generalites">
                <h2>Utilisez les numéros 1-9</h2>
                <p>Le Sudoku se joue sur une grille de 9 × 9 cases, divisée en neuf sous-grilles de 3 × 3 cases. L'objectif est de compléter chaque ligne, chaque colonne et chaque sous-grille avec les chiffres de 1 à 9, sans qu'aucun nombre ne soit répété.</p>
                <p>Bien que ces règles puissent sembler complexes au premier abord, chaque grille de Sudoku propose déjà certaines cases préremplies afin de guider le joueur. Plus le nombre de cases initialement remplies est élevé, plus la grille est facile à résoudre ; à l'inverse, les grilles les plus difficiles comportent très peu d'indices de départ.</p>
                <h2>Ne devinez pas</h2>
            ...
            <div id="regles_repetez">
                <img src="app/view/assets/img/Regles1.webp" alt="">
                <div>
            ...
            <div id="regles_processus">
                <img src="app/view/assets/img/Regles2.webp" alt="">
                <div>
