<body>
    <header>
        <div>
            <a href="index.php"><img class="logo" src="app/view/assets/img/SudokuMaster.png" alt=""></a>
            <nav>
            ...
            <div id="utilisateur">
                ...
                ?>
                <img src="app/view/assets/svg/AvatarUtilisateur.svg" alt="">
                 <?php
                    if(isset($_SESSION["utilisateur"])) {
                ?>
                <div id="menu_utilisateur">
                    <div>
                        <img src="app/view/assets/svg/Profil.svg" alt="">
                    ...
                    <div>
                        <img src="app/view/assets/svg/Accessibilite.svg" alt="">
                        <a href="index.php?#">Accessibilité</a>
                    </div>
                    <div>
                        <img src="app/view/assets/svg/Deconnexion.svg" alt="">
