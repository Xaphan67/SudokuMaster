    ...
    <div class="sections_mentions">
        <section>
            ...
            <ul>
                ...
                <li><a href="#rgpd">4. Protection des données personnelles (RGPD)</a></li>
                <li><a href="#responsabilite">5. Limitation de responsabilité</a></li>
                <li><a href="#droit">6. Droit applicable et juridiction compétente</a></li>
            </ul>
        </section>
        <section id="editeur">
            ...
            <dl>
                ...
                <dd>[Capital social de l'éditeur]</dd>
                <dt>Adresse</dt>
                <dd>[Adresse de l'éditeur]</dd>
                <dt>Téléphone</dt>
                <dd>[Téléphone de l'éditeur]</dd>
                <dt>Email</dt>
                <dd>
                    <a href="mailto:contact@sudoku-master.com">contact@sudoku-master.com</a>
                </dd>
                <dt>Directeur de publication</dt>
                <dd>Cédric Falda</dd>
                <dt>SIRET</dt>
                <dd>[SIRET de l'éditeur]</dd>
            </dl>
        </section>
        <section id="hebergement">
            ...
            <dl>
                <dt>Hébergeur</dt>
                <dd>[Nom de l'hébergeur]</dd>
                <dt>Adresse</dt>
                <dd>[Adresse de l'hébergeur]</dd>
                <dt>Téléphone</dt>
                <dd>[Téléphone de l'hébergeur]</dd>
            </dl>
        </section>
        <section id="propriete">
            ...
            <p>
                ...
                exclusive de SUDOKU MASTER ou de ses partenaires, sauf mention contraire.
            </p>
            <p>
                ...
                écrite préalable de SUDOKU MASTER.
            </p>
            <p>
        ...
        <section id="rgpd">
            ...
            <p>Le responsable du traitement des données est SUDOKU MASTER, représenté par Cédric Falda.</p>
            ...
            <ul>
                <li>Vous identifier aux yeux des autres visiteurs du site</li>
                <li>Vous donner accès à un compte personnel receuillant vos statistiques de jeu</li>
            </ul>
        ...
        <section id="responsabilite">
            ...
            <p>
                SUDOKU MASTER s'efforce de fournir des informations aussi précises que possible. Toutefois, il ne
            ...
            <p>
                SUDOKU MASTER ne pourra être tenu responsable de dommages directs ou indirects résultant de l'accès
