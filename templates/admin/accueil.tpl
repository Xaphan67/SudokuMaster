                    ...
                    <tr>
                        ...
                        <td class="administration_actions">
                            ...
                            <div class="actions">
                                ...
                                <div class="bouton boutonPrincipal boutonIcone{$utilisateur.id_role == 1 ? " inactif" : ""}"">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
            ...
            <table id="utilisateurs">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="administration_actions_large"><div class="bouton boutonPrincipal boutonProfil">Infos</div><div class="bouton boutonPrincipal boutonProfil{$utilisateur.id_role == 1 ? " inactif" : ""}">Supprimer</div></td>
                    </tr>
                    {/foreach}
                </tbody>
            </table>
